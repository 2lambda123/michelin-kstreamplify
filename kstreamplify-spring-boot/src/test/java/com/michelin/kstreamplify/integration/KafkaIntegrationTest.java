...
abstract class KafkaIntegrationTest {
  ...
  @Autowired protected KafkaStreamsInitializer initializer;

  @Autowired protected TestRestTemplate restTemplate;

  protected static void createTopics(String bootstrapServers,
                                     String... topics) {
  ...
  protected void waitingForKafkaStreamsToStart() throws InterruptedException {
    while (!initializer.getKafkaStreams().state().equals(
