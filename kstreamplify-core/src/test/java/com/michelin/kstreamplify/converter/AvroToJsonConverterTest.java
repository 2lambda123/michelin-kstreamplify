...
class AvroToJsonConverterTest {
  ...
  void shouldConvertObject() {
    String json =
        AvroToJsonConverter.convertObject(new PersonStub("John", "Doe"));
        assertEquals("""
            {
  ...
  void shouldConvertListObject() {
    String json = AvroToJsonConverter.convertObject(
        List.of(new PersonStub("John", "Doe")));
        assertEquals("""
            [{
              "firstName": "John",
              "lastName": "Doe"
  ...
  void shouldConvertAvroToJson() {
    String jsonString =
        AvroToJsonConverter.convertRecord(buildKafkaRecordStub());

        assertEquals("""
            {
      "localTimestampMillisField" : "2024-03-27T20:51:01.815832",
                                      "membersString" : {"key1" : "val1"},
                                                          "decimalField" : 10,
                                                          "timeMillisField"
          : "20:51:01.815",
            "booleanField" : false,
          ...
          : ["val1", "val2"],
            "timestampMicrosField" : "2024-03-27T19:51:01.815832Z",
                                       "uuidField"
          : "dc306935-d720-427f-9ecd-ff87c0b15189",
            "split" : [{
              "subSplit" : [{
                "subSubIntField" : 8,
  ...
  private KafkaRecordStub buildKafkaRecordStub() {
    return KafkaRecordStub.newBuilder()
        ...
        .setLocalTimestampMillisField(
            LocalDateTime.parse("2024-03-27T20:51:01.815832"))
        .setLocalTimestampMicrosField(
            LocalDateTime.parse("2024-03-27T20:51:01.815832123"))
        ...
        .setSplit(
            List.of(SubKafkaRecordStub.newBuilder()
                        .setSubField("subTest")
                        .setSubSplit(List.of(
