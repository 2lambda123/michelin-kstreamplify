...
public abstract class KafkaStreamsStarter {
   ...
   * <p>If you don't want to use the DLQ topic, you can return {@link
   * org.apache.commons.lang3.StringUtils#EMPTY}</p>
   *
   ...
   *
   * @return StreamsUncaughtExceptionHandler The custom uncaught exception
   *     handler
   */
